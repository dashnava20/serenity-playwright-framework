...
test.describe('DemoQA - Home', () => {
  ...
  test('Case 1: DemoQA home page | ES: Caso 1 - Navegar a la página principal', async ({ actor }) => {
    ...
    await actor.attemptsTo(
      ...
      Wait.upTo(Duration.ofSeconds(30)).until(DemoQAMainMenu.AllCards.count(), equals(6)),

      // Espera explícita antes de aserciones
      Wait.upTo(Duration.ofSeconds(30)).until(DemoQAMainMenu.Elements, isVisible()),

      // Scroll y aseguramiento de visibilidad de cada tarjeta
